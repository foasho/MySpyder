...
if __name__ == '__main__':
    ...
    try:
        ...
        # #Green wipe
        # print ("\nGreen wipe")
        # led.colorWipe(led.strip, Color(0, 10, 0)) 
        # time.sleep(1)
        
        
        # #Blue wipe
        # print ("\nBlue wipe")
        # led.colorWipe(led.strip, Color(0, 0, 10)) 
        # time.sleep(1)
        
        
        # #White wipe
        # print ("\nWhite wipe")
        # led.colorWipe(led.strip, Color(10, 10, 10)) 
        # time.sleep(1)
        
        led.strip.setPixelColor(3, Color(10, 10, 10))
        led.strip.show()
